...
```{r}
# Extract state from coordinates only where information is missing
...
#> Warning: The following countries listed in the 'country_suggested' column were 
#> absent in the world map used for validation: NATesting countries...
...
#> Warning message:
#> In check_states(occ = occ_checked_country, state_column = "state_suggested",  :
