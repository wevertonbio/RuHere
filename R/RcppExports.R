...
get_rarefaction_components <- function(x) {
    .Call(`_RuHere_get_rarefaction_components`, x)
}

moranfast <- function(x, weight, scaled = FALSE, na_rm = TRUE, alternative = "two.sided") {
