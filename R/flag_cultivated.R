...
#' receive \code{FALSE}, while all other records receive \code{TRUE}. As with
#' all other flagging functions in RuHere, \code{TRUE} indicates that the
#' record passed this test and is eligible for retention; \code{FALSE}
